                                        ...
                                        <div class="flex flex-wrap -m-2">
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <input v-model="form.status" type="radio" id="status" name="status" value="1" class="">未キャンセル
                                                    <input v-model="form.status" type="radio" id="status" name="status" value="0" class="">キャンセルする
                                                </div>
                                            </div>
                                            <div class="p-2 w-full">
